...
export class EditProfile extends Component {
    ...
    dateOfBirth: null,
		...
		address: this.props.data.address.street + ' ' +this.props.data.address.suite,
    ...
    const { close} = this.props;
      ...
      console.log('savechages')
		...
		const { name, email, userName, dateOfBirth,company, phoneNumber, website, address, city, postcode, avatarUrl } = this.state;
		...
		return (
            ...
            <Button type="danger" className="ml-2" onClick={close}>Close</Button>
					</div>
				</Flex>
				<div className="mt-4">
					<Form
